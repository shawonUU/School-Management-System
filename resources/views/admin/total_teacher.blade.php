    ...
    <div class="">
        <div class="row">
                        ...
                        <div class="table table-sm " style="color: white; margin-top: 3rem !important;">
                            <div class="row">
                                <div class="col-12 bg-primary text-center text-bold py-3">Teachers List</div>
                            </div>
                            ...
                            @foreach($teachers as $teacher)
                                @if($teacher['user_type']=='Teacher')
                                    ...
                                    <div class="row sdo bg-success py-2" style="color: white;">
                                        ...
                                        <div class=" col-6 col-lg-2 col-sm-3  d-flex justify-content-end"><span id="{{$teacherinfo[0]->id.'btn'}}" onclick="infolist(<?php echo(json_encode($teacherinfo[0]->id)); ?>)" style="background-color: #007bff;" class="ex btn btn-primary">View</span></div>
                                        <div class=" col-6 col-lg-2 col-sm-3 d-flex justify-content-end"><a  style="background-color: #dc3545;" href="{{'/delete_teacher/'.$teacher['id']}}" class="ex btn btn-danger">Delete</a></div>
                                    </div>
