@extends('templet')
@section('containt')
<div class="row p-4 pt5 pt-3 p-sm-0">
...
<div class="form-inline">
      ...
      <div class="form-group">
          ...
          <input id="user_type" type="text" class="m-2 form-control " name="user_type" value="Admin"  hidden>
              ...
              <a  href="{{route('admin_signup')}}"  class="nav-link d-inline text-white text-left t-sdo">Creat a new account.</a>
          </form>
      </div>
</div>
</div>
