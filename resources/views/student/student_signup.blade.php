					...
					<div class="p-4 p-sm-0 col-xs-12 col-sm-8 col-lg-6 col-sm-offset-2 col-lg-offset-3 mt-5">
						<div class="panel panel-default">
							<div class="panel-heading">
							    <h3 class="panel-title text-center text-white t-sdo">Student Registration</h3>
						    </div>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row d-none">
                                            ...
                                            <div class="col-md-6">
                                                <input id="user_type" type="text" class="form-control @error('user_type') is-invalid @enderror" name="user_type" value="Student_signup" required autocomplete="user_type" autofocus>
										...
										<p class="text-white text-center t-sdo">Already have an account? <a class="nav-link nlk t-sdo" href="{{route('student_signin')}}">Login</a></p>
