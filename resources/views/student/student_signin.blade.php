...
<div class="form-inline">
      ...
      <div class="form-group">
          ...
          <input id="user_type" type="text" class="m-2 form-control " name="user_type" value="Student"  hidden>
              ...
              <a  href="{{route('student_signup')}}"  class="nav-link d-inline text-white text-left t-sdo">Creat a new account.</a>
          </form>
      </div>
</div>
</div>
