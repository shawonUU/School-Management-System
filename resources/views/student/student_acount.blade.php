...
<div class="row pt5 ">
					<div class=" p-4 p-sm-0 col-xs-12 col-sm-8 col-lg-6 col-sm-offset-2 col-lg-offset-3 mt-5">
						<div class="panel panel-default">
							<div class="panel-heading">
							    <h3 class="panel-title text-center text-white t-sdo">Fillup the admission form</h3>
						    </div>
                            ...
                            <form method="POST" action="student-form">
                                @csrf
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-6">
                                                <input id="father_name" type="text" class="m-2 sdo form-control @error('father_name') is-invalid @enderror" name="father_name" required autocomplete="father_name" placeholder="Father Name">
                                            ...
                                            <div class="col-md-6">
                                                <input id="mother_name" type="text" class="m-2 sdo form-control @error('mother_name') is-invalid @enderror" name="mother_name" required autocomplete="mother_name" placeholder="Mother Name">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6"> 
                                                <select id="class" name="class"class="m-2 sdo form-select" aria-label="Default select example">
                ...
                @elseif(Auth::user()->user_type=='Student_fillup')
                <div class="pt5 container">
                    <p class="display-6 text-white text-center t-sdo mt-5">
                    You are not approved as a Student to the School. If you will be approved as a student you can access Student dashbord.
                    </p>
